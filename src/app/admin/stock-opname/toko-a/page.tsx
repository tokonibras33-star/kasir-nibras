      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <Input placeholder="Cari nama produk atau warna..." className="pl-10 h-10 md:h-11 rounded-xl bg-white border-none shadow-sm text-sm" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
          </div>
        </div>
      </div>
            ...
            <Table>
              ...
              <TableBody>
                {flattenedVariants.length > 0 ? flattenedVariants.map((item, idx) => {
                  ...
                  return (
                    <TableRow key={idx} className="hover:bg-muted/20 border-b border-muted/50 transition-colors">
                      ...
                      <TableCell className="text-center px-2">
                        <Input 
                          type="number" 
                          className="h-8 md:h-9 text-center text-[11px] md:text-xs font-black rounded-lg border-2 border-primary/10 focus-visible:border-primary shadow-none p-0" 
                          placeholder="0"
                  ...
                  <TableRow><TableCell colSpan={5} className="h-48 text-center text-muted-foreground italic">Belum ada data produk tersedia.</TableCell></TableRow>
                )}
              </TableBody>
            </Table>
          </div>
