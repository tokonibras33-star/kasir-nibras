      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <Input placeholder="Cari nama, merk, no nota..." className="pl-10 h-10 md:h-11 rounded-xl bg-white border-none shadow-sm text-sm" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
          </div>
        </div>
      </div>
            ...
            <Table>
              ...
              <TableBody>
                {flattenedVariants.length > 0 ? flattenedVariants.map((item, idx) => {
                  ...
                  return (
                    <TableRow key={idx} className="hover:bg-muted/20 border-b border-muted/50 transition-colors text-[11px]">
                      ...
                      <TableCell className="text-center">
                        <Input 
                          type="number" 
                          className="h-8 text-center text-[11px] font-black rounded-lg border-2 border-blue-100 focus-visible:border-blue-500 shadow-none p-0" 
                          placeholder="0"
                  ...
                  <TableRow><TableCell colSpan={12} className="h-48 text-center text-muted-foreground italic">Tidak ada data rincian untuk toko ini.</TableCell></TableRow>
                )}
              </TableBody>
            </Table>
          </div>
