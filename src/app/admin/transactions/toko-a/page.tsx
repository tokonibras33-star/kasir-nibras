...
export default function TransactionsTokoAPage() {
  ...
  const exportToPDF = () => {
    ...
    docPdf.text(`Periode: ${filterMode === 'daily' ? selectedDate : selectedMonth}`, 105, 16, { align: "center" });
    ...
    docPdf.save(`transaksi-toko-a-${filterMode}-${filterMode === 'daily' ? selectedDate : selectedMonth}.pdf`);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold font-headline tracking-tight text-primary">Transaksi Toko A</h1>
          <p className="text-muted-foreground text-sm">Monitoring riwayat penjualan cabang Toko A.</p>
        </div>
